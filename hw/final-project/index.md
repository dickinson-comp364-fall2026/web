...
*   **FP1:** In the `README` of your project repository, create a new section labeled with the heading **FP1** describing in 100-300 words:
...
*   **FP2:** In the `README` of your project repository, update your progress relative to the plan outlined in FP1. Retain the FP1 section, and add a new section labeled **FP2** describing:
    *   The coding milestone that has been achieved.
